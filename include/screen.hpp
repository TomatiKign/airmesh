...
/**
 * @brief creates screen dimensions
 * @var uint8_t of screen width and screen height
 */
...
/**
 * @brief Resets the canvas in preparation for another frame, this should be called before drawing anything to the canvas
 */
...
/**
 * @brief Displays the current program status on the screen, as an alternative to `Serial.print`
